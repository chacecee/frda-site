        ...
        <main className="relative min-h-screen overflow-hidden bg-[#030713] text-white">
            ...
            <div className="relative z-10">
                            ...
                            >
                                <div className="relative overflow-hidden bg-transparent sm:border-b sm:border-white/10 sm:bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,0.16),transparent_46%)]">
                                    {profile.availabilityLabel ? (
                                        ...
                                        >
                                            <span
                                                className={`h-1.5 w-1.5 rounded-full ${profile.availabilityLabel
                                                        .toLowerCase()
                                                        .includes("limited")
                                                        ? "bg-amber-300"
                                                        : "bg-emerald-300"
                                        ...
                                        <div className="w-full min-w-0 text-center sm:text-left">
                                            ...
                                            <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row sm:justify-start">
                                                <button
                                                    ...
                                                    className={`inline-flex min-h-12 w-full max-w-sm items-center justify-center gap-2 border px-6 py-3.5 text-sm font-semibold backdrop-blur-md transition sm:w-auto ${isOwnProfile
                                                ...
                                                {!isOwnProfile ? (
                                                    <button
                                                        ...
                                                        className={`inline-flex min-h-12 cursor-pointer items-center justify-center gap-2 border px-4 py-3.5 text-sm font-semibold transition disabled:cursor-wait ${isSaved
                ...
                {profile && !isOwnProfile ? (
                    <div
                        className={`fixed inset-x-0 bottom-0 z-[90] px-3 pb-[max(12px,env(safe-area-inset-bottom))] transition-all duration-300 sm:hidden ${showStickyContact
